      ...
      <div className="mx-auto text-center container">
        ...
        <div className="mb-[70px] flex justify-between items-center mx-auto max-w-4xl">
          <div className="flex items-center space-x-4">
            <span className={`${isPremium ? 'font-semibold' : ''}`}>
              Premium
            </span>
            <Switch
              checked={isPremium}
            ...
            >
              ...
              <div>
                ...
                <ul className="list-disc pl-5 text-left text-[13px] leading-[20px] text-[#33336f] space-y-2">
                  <li>
                    Cloudflare Add-on{' '}
                    <span className="inline-block px-[6px] py-[3px] text-[13px] font-bold leading-[13px] text-white align-middle bg-[#0b2cb1] rounded-[6px]">
                      NEW
                    </span>
                  </li>
